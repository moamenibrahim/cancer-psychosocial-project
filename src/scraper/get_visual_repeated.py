...
wordcount = {}
keywords = finnish_keywords.illness_list + finnish_keywords.financial_list + \
    finnish_keywords.death_list + finnish_keywords.social_list + \
    finnish_keywords.treatment_list
