...
for x in range(2014, 2019):
    ...
    for line in f.readlines():
        ...
        try:
            ...
            filtered_topics = [w for w in all_topic if not w in set(
                stopwords.words('english'))]
            filtered_topics = [
                w for w in filtered_topics if not w in list(string.punctuation)]
        ...
        try:
            ...
            all_named = [w for w in all_named if not w in list(
                string.punctuation)]
...
data_pos_total = [data_pos[0], data_pos[1],
                  data_pos[2], data_pos[3], data_pos[4]]
data_named_total = [data_named[0], data_named[1],
                    data_named[2], data_named[3], data_named[4]]
data_dict_total = [data_dict[0], data_dict[1],
                   data_dict[2], data_dict[3], data_dict[4]]
data_topic_total = [data_topic[0], data_topic[1],
                    data_topic[2], data_topic[3], data_topic[4]]
data_named_count_total = [data_named_count[0], data_named_count[1],
                          data_named_count[2], data_named_count[3], data_named_count[4]]
data_length_total = [data_length[0], data_length[1],
                     data_length[2], data_length[3], data_length[4]]
data_sentiment_total = [data_sentiment[0], data_sentiment[1],
                        data_sentiment[2], data_sentiment[3], data_sentiment[4]]
